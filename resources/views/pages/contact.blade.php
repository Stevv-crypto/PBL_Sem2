...
<body class="font-sans bg-white">
    ...
    <header class="header">
      ...
      <div class="navbar flex justify-between items-center bg-[#b0cee3] px-8 py-3">
        ...
        <nav class="menu flex gap-8 mr-16">
          ...
          <a href="#" class="text-black text-base hover:text-gray-700 underline font-medium">Contact</a>
  ...
  <div class="flex flex-row items-center gap-3 mt-10 ml-[135px]">
    ...
    <a href="contact.html" class="text-black hover:underline">Contact</a>
  </div>

  <!-- Main Content -->
  <div class="flex items-start justify-between px-10 py-6 max-w-6xl mx-auto gap-8">
    ...
    <form class="w-2/3 bg-white p-6 rounded-xl shadow">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        <input type="text" placeholder="Your Name"
          class="p-3 border rounded-none bg-[#e8dedd] focus:outline-none focus:ring-2 focus:ring-blue-500" />
      ...
      <textarea placeholder="Your Message"
        class="w-full h-32 p-3 border rounded-none bg-[#e8dedd] resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 mb-4"></textarea>
